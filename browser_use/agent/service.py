...
class Agent(Generic[Context]):
	...
	async def run(
		...
		# nyw - Create a new workflow tree for this run
		# self.workflow_tree = WorkflowTree() // return [None] if not self.workflow_tree else self.workflow_tree
		...
		try:
			...
			for step in range(max_steps):
				...
				# NYW - Create a new step info object
				# just to do step 
